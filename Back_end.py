class Villain:
    ...
    def registration(self, original_screen): #use for adding a record in database
        import tkinter
        ...
        def back():
            import exp
            exp.back(self.root, original_screen,self.password)
        ...
        def no():
            import tkinter
            global r
            original_screen.geometry('1200x375')
            ...
            r = tkinter.IntVar()
            r1 = tkinter.Radiobutton(self.root, text='Yes', variable=r, value=1, fg='red', command=check, bg='black',
                                     font=('Times', '20'),
            ...
            r1.deselect()
            r2 = tkinter.Radiobutton(self.root, text='No', variable=r, value=0, fg='red', bg='black', command=check,
                                     font=('Times', '20'),
                                     width=20, borderwidth=2,
                                     relief='solid', highlightbackground='grey', highlightthickness=2)
        ...
        def check():
            ...
            if r.get() == 1:
                ...
                tkinter.Label(self.root, text="Are the given Entries correct-", fg='red', bg='black',
                              ...
                              relief='solid').grid(row=7, column=0, sticky=tkinter.W + tkinter.E)
                tkinter.Button(self.root, text='Yes', command=yes, fg='red', bg='black', font=('Times', '18'), width=20,
                               borderwidth=2,
                               relief='solid',
                               highlightbackground='grey', highlightthickness=1).grid(row=7, column=1,
                                                                                      sticky=tkinter.W + tkinter.E)
                tkinter.Button(self.root, text='No', command=no, fg='red', bg='black', font=('Times', '18'), width=20,
                               borderwidth=2,
                               relief='solid',
        ...
        l8 = tkinter.Label(self.root, text="Enter the name of  villain", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey',
                           highlightthickness=2,
                           relief='solid')
        l8.grid(row=1, column=0, sticky=tkinter.W + tkinter.E)
        l2 = tkinter.Label(self.root, text="Enter his/her secret name", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey',
                           highlightthickness=2,
                           relief='solid')
        l2.grid(row=2, column=0, sticky=tkinter.W + tkinter.E)
        l3 = tkinter.Label(self.root, text="Enter the alternate name of his/her ", fg='red', bg='black',
                           font=('Times', '20'),
                           highlightbackground='grey', highlightthickness=2,
                           relief='solid')
        l3.grid(row=3, column=0, sticky=tkinter.W + tkinter.E)
        l4 = tkinter.Label(self.root, text="Enter date of birth of villain (YYYY-MM-DD) ", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey', highlightthickness=2,
                           relief='solid')
        l4.grid(row=4, column=0, sticky=tkinter.W + tkinter.E)
        l5 = tkinter.Label(self.root, text="Enter the bank balance", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey',
                           highlightthickness=2,
                           relief='solid')
        l5.grid(row=5, column=0, sticky=tkinter.W + tkinter.E)
        l6 = tkinter.Label(self.root, text="Enter the Sex of the villain", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey',
                           highlightthickness=2,
                           relief='solid')
        l6.grid(row=6, column=0, sticky=tkinter.W + tkinter.E)
        l7 = tkinter.Label(self.root, text="Are the given Entries correct-", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey', highlightthickness=2, borderwidth=4,
                           relief='solid')
        l7.grid(row=7, column=0, sticky=tkinter.W + tkinter.E)
    ...
    def show_records(self, ab):
        def back():
            import exp
            exp.back(self.root, ab,self.password)
        ...
        for i in data:
            ...
            for j in range(0, 7):
                ran = tkinter.Label(self.root, text=i[j], fg='red', bg='black', font=('Times', '15'), padx=20,
                                    highlightbackground='grey',
                                    highlightthickness=2, relief='solid')
                ran.grid(row=r, column=a, sticky=tkinter.W + tkinter.E)
                a = a + 1
            r = r + 1
        b3 = tkinter.Button(self.root, text='Back', command=back, fg='red', bg='black', font=('Times', '15'), width=10,
                            relief='solid',
    ...
    def deleted(self, ab):
        ...
        def dele():
            ...
            sen = e1.get()
            sen = sen.split('--')
            cur.execute(f'delete from gotham_villain where Secret_identity = "{sen[1]}" ')
            mycom.commit()
        ...
        slide.config(fg='red', bg='black', font=('Times', '15'), width=40, relief='solid',
                     highlightbackground='grey', highlightthickness=2)
        slide.grid(row=1, column=0, sticky=tkinter.W + tkinter.E, columnspan=3)
        b3 = tkinter.Button(self.root, text='Delete', command=dele, fg='red', bg='black', font=('Times', '15'),
                            width=10,
                            relief='solid',
                            highlightbackground='grey', highlightthickness=2)
    ...
    def updated(self, ab):
        ...
        l3 = tkinter.Label(self.root, text="Enter the alternate name of his/her ", fg='red', bg='black',
                           ...
                           relief='solid')
        l3.grid(row=3, column=0, sticky=tkinter.W + tkinter.E)
        l4 = tkinter.Label(self.root, text="Enter date of birth of villain", fg='red', bg='black', font=('Times', '20'),
                           highlightbackground='grey', highlightthickness=2,
                           relief='solid')
        l4.grid(row=4, column=0, sticky=tkinter.W + tkinter.E)
        l5 = tkinter.Label(self.root, text="Enter the bank balance", fg='red', bg='black', font=('Times', '20'),
        ...
        slide.config(fg='red', bg='black', font=('Times', '15'), width=40, relief='solid',
                     highlightbackground='grey', highlightthickness=2)
        slide.grid(row=7, column=0, sticky=tkinter.W + tkinter.E, columnspan=3)
        b3 = tkinter.Button(self.root, text='Update', command=opp, fg='red', bg='black', font=('Times', '15'),
                            width=10,
                            relief='solid',
                            highlightbackground='grey', highlightthickness=2)
